...
export const LETTERS = [
  {
    ...
    name: 'Alef',
    roman: 'a / ā',
    hint: 'One tall vertical stroke, slightly slanted right.',
    nonJoiner: true,
  },
  ...
  { letter: 'ث', name: 'Tha', roman: 'th', hint: 'Same base — three dots above in a triangle.' },
  {
    ...
    name: 'Jim',
    roman: 'j',
    hint: 'Hook curves right then sweeps under, one dot below.',
  },
  ...
  { letter: 'خ', name: 'Kha', roman: 'kh', hint: 'Same hook — one dot above.' },
  {
    ...
    name: 'Dal',
    roman: 'd',
    hint: 'Angular wedge, like a right-angled hook.',
    nonJoiner: true,
  },
  {
    letter: 'ذ',
    name: 'Dhal',
    roman: 'dh',
    hint: 'Same as Dal with one dot above.',
    nonJoiner: true,
  },
  {
    letter: 'ر',
    name: 'Ra',
    roman: 'r',
    hint: 'Gentle curve swooping down to the right.',
    nonJoiner: true,
  },
  {
    letter: 'ز',
    name: 'Zay',
    roman: 'z',
    hint: 'Same curve as Ra — one dot above.',
    nonJoiner: true,
  },
  ...
  { letter: 'ش', name: 'Shin', roman: 'sh', hint: 'Same three waves — three dots above.' },
  {
    ...
    name: 'Sad',
    roman: 'ṣ',
    hint: 'Round head on the left, long tail sweeping right.',
  },
  ...
  { letter: 'غ', name: 'Ghain', roman: 'gh', hint: 'Same as Ain — one dot above.' },
  {
    ...
    name: 'Fa',
    roman: 'f',
    hint: 'Circle on the left, tail sweeping right, dot above.',
  },
  ...
  { letter: 'ه', name: 'Ha', roman: 'h', hint: 'Figure-eight-like loops — no dots.' },
  {
    ...
    name: 'Waw',
    roman: 'w / ū',
    hint: 'Circle on the right, tail curves down-left.',
    nonJoiner: true,
  },
  {
    letter: 'ي',
    name: 'Ya',
    roman: 'y / ī',
    hint: 'Two humps, tail hooks under with two dots below.',
  },
